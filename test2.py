...
#    title_text = 'PEAK PERFORMANCE',
    ...
    margin=dict(l=25, r=110, t=30, b=25, pad=3),
...
fig.add_annotation(x=-0.05, y=0.5, xref="paper", yref="paper", showarrow=False, text="TOTAL<br>PERFORMANCE", font=dict(size=14), textangle=-90)
