...
fig.update_xaxes(title_text="Days", ticks="inside", tick0=0.0, showline=True, linewidth=1, linecolor='white', mirror=True, showgrid=True, dtick=30, row=1, col=2)
...
fig.update_xaxes(title_text="Days", ticks="inside", showgrid=True, showline=True, linewidth=1, linecolor='white', mirror=True, tick0=0.0, dtick=30, row=1, col=3)
